...
# 随机分 #
df_all = df_train = dfset2_1D.append([dfset1_1D,dfset1_2D,dfset1_3D,dfset1_4D,dfset1_5D,dfset2_2D,dfset2_3D,dfset2_4D,dfset3_1D,dfset3_2D,dfset3_3D,dfset3_4D,dfset3_5D])
x,y = np.split(df_all,(40,),axis = 1)
x_train, x_test, y_train, y_test = TTS(x, y, train_size=0.9, random_state=5)
...
#                 'seed': 0}
other_params = {'n_estimators ':1,'min_samples_leaf':10}
...
try_different_method(fig1,RFR(**other_params),2)
